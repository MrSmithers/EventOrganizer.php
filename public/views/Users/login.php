...
<div class="container login-container">
    <form class="form-signin col-lg-12 login-form" id="login-form" action="/login" method="post">
        ...
        <label class="checkbox col-lg-12"><input type="checkbox" value="remember-me" /> <span class="checkbox-text">Remember me</span></label>
        <input class="input-block-level" type="hidden" name="redirect" value="<?php echo $redirect; ?>"/>
